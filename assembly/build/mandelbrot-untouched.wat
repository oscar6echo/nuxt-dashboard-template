(module
 ...
 (type $FUNCSIG$iddddiiiii (func (param f64 f64 f64 f64 i32 i32 i32 i32 i32) (result i32)))
 (type $FUNCSIG$iddi (func (param f64 f64 i32) (result i32)))
 (type $FUNCSIG$iddddiiii (func (param f64 f64 f64 f64 i32 i32 i32 i32) (result i32)))
 ...
 (data (i32.const 416) "\04\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\001\00\00\00\02\00\00\00")
 (table $0 1 funcref)
 ...
 (global $assembly/mandelbrot/UINT8ARRAY_ID i32 (i32.const 3))
 ...
 (export "UINT8ARRAY_ID" (global $assembly/mandelbrot/UINT8ARRAY_ID))
 (export "computeRow" (func $assembly/mandelbrot/computeRow))
 (export "computeGrid" (func $assembly/mandelbrot/computeGrid))
 ...
 (func $assembly/mandelbrot/mandelbrotEscapeIter (; 30 ;) (type $FUNCSIG$iddi) (param $0 f64) (param $1 f64) (param $2 i32) (result i32)
  (local $3 f64)
  (local $4 f64)
  (local $5 f64)
  (local $6 i32)
 ...
 (func $~lib/typedarray/Uint8Array#__get (; 32 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  local.get $1
  local.get $0
  i32.load offset=8
  i32.ge_u
 ...
 (func $assembly/mandelbrot/computeRow (; 33 ;) (type $FUNCSIG$iddddiiiii) (param $0 f64) (param $1 f64) (param $2 f64) (param $3 f64) (param $4 i32) (param $5 i32) (param $6 i32) (param $7 i32) (param $8 i32) (result i32)
  (local $9 i32)
  (local $10 f64)
  (local $11 i32)
  (local $12 f64)
  ...
  block $break|0
   ...
   loop $loop|0
    ...
    local.get $10
    local.get $6
    call $assembly/mandelbrot/mandelbrotEscapeIter
    local.set $13
    local.get $13
    local.get $6
    i32.eq
 ...
 (func $assembly/mandelbrot/computeGrid (; 34 ;) (type $FUNCSIG$iddddiiii) (param $0 f64) (param $1 f64) (param $2 f64) (param $3 f64) (param $4 i32) (param $5 i32) (param $6 i32) (param $7 i32) (result i32)
  (local $8 i32)
  (local $9 i32)
  (local $10 f64)
  (local $11 i32)
